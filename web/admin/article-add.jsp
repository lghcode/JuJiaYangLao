...
<body>
<form class="vali_form" action="News-save.action" method="post">
    <div><h5 class="h1"><span>*</span>文章标题:</h5><input type="text" class="ip1" name="news.ntitle" datatype="*" errormsg="请输入文章标题"/></div>
    ...
    <div><h5 class="h3"><span>*</span>编辑人员:</h5><input type="text" class="ip3" name="news.writer" datatype="*" errormsg="请输入编辑人员"/></div>
