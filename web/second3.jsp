    ...
    <div class="wen" style="height: 600px;border: 1px solid #0a63ab">
        ...
        <ul class="biao">
            ...
            <c:if test="${requestScope.busis!=null}">
                <c:forEach items="${requestScope.busis}" var="bu">
                    <li><a href="${pageContext.request.contextPath}/Business-get2.action?business.bid=${bu.bid}">${bu.bname}</a></li>
                </c:forEach>
            </c:if>
        </ul>
        ...
        <div class="fenYe">
            ...
            <form action="${pageContext.request.contextPath}/Business-query2.action" method="post">
...
<script type="text/javascript">
    ...
    function firstPage(){
        if(currentPage == 1){
            ...
            submitForm("${pageContext.request.contextPath}/Business-query2.action?pageNum=1");
            return true;
        }
    }
    ...
    function nextPage(){
        if(currentPage == totalPage){
            ...
            submitForm("${pageContext.request.contextPath}/Business-query2.action?pageNum="+(currentPage+1));
            return true;
        }
    }
    ...
    function lastPage(){
        if(currentPage == totalPage){
            ...
            submitForm("${pageContext.request.contextPath}/Business-query2.action?pageNum="+${requestScope.result.totalPage});
            return true;
        }
    }
    /*
